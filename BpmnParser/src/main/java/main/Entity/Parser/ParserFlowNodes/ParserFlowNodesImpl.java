...
public class ParserFlowNodesImpl implements ParserFlowNodes {
    ...
    public ParserFlowNodesImpl(BpmnModelInstance modelInstance) {
        this.modelInstance = modelInstance;
        parseFlowNodesHelper = new ParseFlowNodesHelperImpl(modelInstance);
        camundaHelper = parseFlowNodesHelper.getCamundaHelper();
    }
    ...
    //region REGION: add: TrainingPhrases, InputContextIDs, Output IntentIDs&ContextIDs
    /*
     * PARSE FLOW NODES
     */
    ...
    @Override
    public void parseFlowNode(ParserFlowNodesDTO parserFlowNodesDTO) throws IOException {
        Intents intents = new Intents();

        FlowNode node = parserFlowNodesDTO.getFlowNode();
        Participant participant = parserFlowNodesDTO.getParticipant();
        Process process = parserFlowNodesDTO.getProcess();
    ...
    //region REGION: Parse Exclusive Gateway
    /**
    ...
    //region REGION: Parse Message Flow
    ...
    //region REGION: Parse (Source,Target)MessageFlow
    /*
    ...
    //region REGION: Parse Parallel Gateway
    /*
    ...
    //region REGION: get Input/Output Context, Output Intent
    /*
