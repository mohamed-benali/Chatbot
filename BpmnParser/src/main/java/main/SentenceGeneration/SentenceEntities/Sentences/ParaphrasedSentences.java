...
public class ParaphrasedSentences {
    ...
    public void addMultipleParaphrasedSentencesToNewSentence(String key, Sentences sentences) {
    ...
    public void addMultipleParaphrasedSentencesToExistingSentence(String key, Map<String, Sentence> sentencesToAdd) {
        Sentences sentences = this.paraphrasedSentences.get(key);
        sentences.addSentences(sentencesToAdd);
        //TODO: Hauria de ser suficient perque es una referencia
    }

    public void addMultipleParaphrasedSentencesToExistingSentence(String key, Sentences sentencesToAdd) {
        Sentences sentences = this.paraphrasedSentences.get(key);
        sentences.addSentences(sentencesToAdd);
        //TODO: Hauria de ser suficient perque es una referencia
    }
